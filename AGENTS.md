...
| --- | --- |
| 프론트엔드 전체 아키텍처·규칙 | `apps/client/AGENTS.md` |
| Next.js App Router·전역 레이아웃·메타데이터·PWA | `apps/client/src/app/AGENTS.md` |
| UI 컴포넌트·Storybook | `apps/client/src/components/AGENTS.md` |
| SVG 아이콘 등 코드형 에셋 | `apps/client/src/assets/AGENTS.md` |
| class merge 등 프론트 공통 유틸 | `apps/client/src/lib/AGENTS.md` |
| Storybook 문서/설정 | `apps/client/src/stories/AGENTS.md` |
| 프론트 전용 공통 타입 | `apps/client/src/types/AGENTS.md` |
...
| 스타일 | Tailwind CSS 4 | `src/app/globals.css` token 우선 |
...
- `CLAUDE.md`가 아니라 **`AGENTS.md` 계층을 agent 작업 지침의 기준**으로 사용합니다.
- 수정하려는 폴더에 하위 `AGENTS.md`가 있으면 먼저 읽고 따릅니다.
